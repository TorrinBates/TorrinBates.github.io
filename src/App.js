...
function App() {
  ...
  return (
  <div className="imac">
    <div className="screen" onKeyDown={captureKey} tabIndex="0">
      <div className="facetime__camera"/>
      <div>
        <div className="Container">
          <h1 className="Name">&#10095; {cmd}</h1>
          <h1 className="Blink">&#9646;</h1>
        </div>
      </div>
    </div>
    <div className="chin">
      <svg className="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
